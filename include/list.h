 ...
 * 
 */
static inline void insert_before_node(struct list_head* node1, struct list_head* node2){
 ...
 * 
 */
static inline void insert_after_node(struct list_head* node1, struct list_head* node2){
 ...
 *
 */
static inline void list_insert(struct list_head* next_node, struct list_head* node){
    struct list_head* tmp = next_node->prev;
    node->next = next_node;
    node->prev = tmp;
    next_node->prev = node;
    tmp->next = next_node;
...
/**
 * list_has_next() - Check if node has next node
 */
static inline int list_has_next(const struct list_head* node, struct list_head* head){
